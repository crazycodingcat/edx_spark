...
def getCountsAndAverages(IDandRatingsTuple):
    ...
    return (IDandRatingsTuple[0], (count, float(sum([r for r in IDandRatingsTuple[1]])) / count))
...
# TODO: Replace <FILL IN> with appropriate code
myModel = ALS.train(trainingRDD, 4, seed=seed, iterations=iterations,
                      lambda_=regularizationParameter)
...
for ratingsTuple in movieLimitedAndSortedByRatingRDD.take(150):
    print ratingsTuple
...
myUnratedMoviesRDD = (moviesRDD
                      ...
                      .filter(lambda x: x[1] not in [l[1] for l in myRatedMovies]))
